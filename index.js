...
let legalname = studentFirstName + ' ' + studentLastName;

console.log(`${legalname} has an average grade of ${average}`);

//4. Write code that would answer this question: Did the student pass?

console.log(`Student ${legalname} pass because his grade is more the ${passingGrade}`);